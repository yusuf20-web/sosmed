    ...
    <div class="container-xxl">
      <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              <h4 class="mb-2 fw-bold fs-3 text-center">REGISTER 🚀</h4>
              <p class="mb-4 text-center">Silahkan Register Akun Anda</p>

              <!-- MEMBUAT KONDISI ALERT JIKA BERHASIL REGISTER -->
              <?php if (isset($_GET['register'])): ?>
                <div class="alert alert-success">Registrasi akun berhasil</div>
              <?php endif ?>
              <form id="formAuthentication" class="mb-3" action="../controller/aksi-register.php" method="POST">
                <div class="mb-3">
                ...
                <button class="btn btn-primary d-grid w-100" name="register">Register</button>
              </form>
