    ...
    <div class="container-xxl">
      <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              <h4 class="fw-bold fs-3 text-center">Selamat Datang</h4>
              <p class="mb-4 text-center">Silahkan Masukan Akun Anda</p>
             <?php if(isset($_GET['email%tidak%terdaftar'])) : ?>
              ...
              <div class="alert alert-success" role="alert">
                <p>Akun berhasil di daftarkan</p>
              </div>
              <?php endif; ?>
              <form action="../controller/aksi-login.php" id="formAuthentication" class="mb-3" action="index.php" method="POST">
                <div class="mb-3">
